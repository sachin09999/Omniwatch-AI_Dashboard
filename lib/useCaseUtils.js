...
export function sanitizeUseCaseId(useCaseId = '') {
  if (!useCaseId || useCaseId === 'all') return 'bf6e9245-1e14-4d11-a467-41ebd48c93a4';
  const raw = String(useCaseId).trim().toLowerCase();
  
  if (raw === 'e0820c96-a414-4fd1-aaae-4fa3beaaee7f') {
    return 'bf6e9245-1e14-4d11-a467-41ebd48c93a4';
  }
  if (raw === 'ca6503cf-f881-4773-ab46-f6f22289d1bf') {
    return 'ae933a6f-c17c-49e1-9fbc-8e75710100e7';
  }
  
  // Check known valid IDs
  if (raw === 'bf6e9245-1e14-4d11-a467-41ebd48c93a4' ||
      raw === 'ae933a6f-c17c-49e1-9fbc-8e75710100e7' ||
      raw === 'f3803638-3844-45d5-ad8f-930d25605b6b') {
    return raw;
  }
  
  // Fuzzy match
  if (raw.includes('face') || raw.includes('fr')) return 'f3803638-3844-45d5-ad8f-930d25605b6b';
  if (raw.includes('obj')) return 'ae933a6f-c17c-49e1-9fbc-8e75710100e7';
  if (raw.includes('anpr')) return 'bf6e9245-1e14-4d11-a467-41ebd48c93a4';
